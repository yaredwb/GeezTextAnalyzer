...
st.write('''ከግዕዝና ሣድስ ዝርያዎች በተደጋጋሚ የሚያጋጥሙት የትኞቹ እንደሆኑ ማወቅ ጠቃሚ ይሆናል። \
  መጀመሪያ የሁለቱን ዝርያዎች ተቀዳሚ ድግግሞሾች ለየብቻ በማጥናት ከዚያም የሁለቱን ዝርያዎች ቅልቅል \
  ተቀዳሚ ድግግሞሾች ማየት ይቻላል። ይህንን ትንታኔ እጅግ በጣም ብዙ ለሆነ ጽሑፍ በመተግበር እነዚህን \
  ድግግሞሾች የተመለከተ አጠቃላይ ድምዳሜ ላይ መድረስ ይቻላል።''')
...
st.markdown('''ዓሳ በዘይት! :-) ማለቴ በጣም ቀልጣፋና በተቻለ መጠን አነስተኛ ቁጥር ያላቸዉን ቁልፎች \
  በመጫን ለመጻፍ የሚያስችል ኪቦርድ ዲዛይን ለማድረግ ይህን ከግምት ውስጥ ማስገባት ወሳኝ ነው። ከተደጋጋሚ \
  ሙከራ በኋላ እንዳስተዋልኩት በርግጥም ሣድስ ፊደላት ብዙ ጊዜ አብዛኛውን ቁጥር የሚይዙ ሲሆን የግዕዝ ዝርያ \
  ፊደላት ደግሞ ብዙ ጊዜ በሁለተኛ ደረጃ ላይ ይመጣሉ። ምናልባትም በሣድስ እና በግዕዝ ፊደላት ላይ ደግሞ \
  ተጨማሪ ምርመራ በማድረግና የትኞቹ ፊደላት በብዛት እንደሚያጋጥሙ በማየት ሁለቱንም ያመዛዘነ በጣም \
  ቀልጣፋ ኪቦርድ መስራት የሚቻል ይመስለኛል። ሞባይል ላይ እስካሁን ከተጠቀምኩባቸው ኪቦርዶች `አገርኛ Compact` \
  በሣድስ ላይ የተመሰረተና (ከአገርኛ ሌሎች አቀማመጦች በተጨማሪ) ለመጠቀም ቀላል የሆነ ኪቦርድ አለው። በሌላ \
  በኩል የ`Microsoft Swiftkey Amharic` ኪቦርድ በዋናነት በግዕዝ ዝርያዎች ላይ የተመሰረተ ነው። በቅርቡ \
  ከግዕዝ እና ከሣድስ ዝርያዎች የትኞቹ ፊደላት በተቀዳሚነት በብዛት እንደሚያጋጥሙ ለማሳየት እሞክራለሁ።
  ''')
...
st.markdown(
  ...
  [Personal Website](https://yaredwb.com/)
  '''
)